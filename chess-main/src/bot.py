...
gerando um valor numérico. O valor é maior se a posição
concede vantagem ao lado que joga.
Cada peça tem um valor relativo dependendo da posição e do
que peça é. Os valores de acordo com as posições foram tomados
de https://www.chessprogramming.org/Simplified_Evaluation_Function
